...
#include <stdint.h>
	...
	*/
	...
	typedef uintptr_t              UIntPtr;
        ...
        typedef unsigned long      s_UInt64; // TODO
	#else
	...
	*/
	...
	typedef signed int             Int32;
	typedef unsigned int           UInt32;
    typedef unsigned __int64       s_Int64;
    typedef signed __int64         s_UInt64;
	typedef unsigned long          UIntPtr;
    #define BEA_HAVE_INT64 1
...
C_STATIC_ASSERT(sizeof_Int64 , (sizeof(s_Int64)  == 8));
C_STATIC_ASSERT(sizeof_UInt64, (sizeof(s_UInt64) == 8));

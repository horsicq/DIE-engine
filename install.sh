...
cp -Rf $X_SOURCE_PATH/dep/XStyles/qss/                                  $X_PREFIX/lib/die/
cp -f $X_SOURCE_PATH/dep/signatures/crypto.db                           $X_PREFIX/lib/die/signatures/
cp -Rf $X_SOURCE_PATH/dep/XInfoDB/info/                                 $X_PREFIX/lib/die/
